...
on run
	...
	try
		set alertResult to (display alert "What To Expect" message "This utility will stop the batch queue, remove all existing jobs from the queue, and delete the contents of all existing batch queue folders." & return & return & queueMessage & return & "Do you wish to Cancel or Continue?" as informational buttons {"Cancel", "Continue"} cancel button "Cancel" giving up after 10)
